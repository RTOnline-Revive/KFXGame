//-----------------------------------------------------------
//  Class:      KFXGame.KFXCombatMessage_KillAnimal
//  Creator:    wangkai@kingsoft 王凯
//  Data:       2008-08-27
//  Desc:       杀猪杀龟战斗消息
//  Update:
//  Special:
//-----------------------------------------------------------
class KFXCombatMessage_KillAnimal extends KFXInstCombatMessage;
        ...
        if ( (!RelatedPRI_1.bOnlySpectator) && (P.Pawn != none) )//不是观查者？？？
        {
            ...
            if ( RelatedPRI_1 != RelatedPRI_2 && RelatedPRI_2 != none )
			{
                    ...
                    && KFXPlayer(P).MultiKillLevel < 2)//无连杀
                {
                    ...
                    {
                        PlayEncourageSound(P, ET_Special);
                    }
                }
			}
		}
